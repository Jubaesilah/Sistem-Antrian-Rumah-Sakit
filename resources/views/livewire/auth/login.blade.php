<div
    class="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
            class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-purple-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-4000">
        </div>
    </div>
    ...
    <div class="relative w-full max-w-md px-6 py-8">
        ...
        <!-- Main Card -->
        <div
            class="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl shadow-gray-300/50 p-8 border border-white/20 animate-fade-in-up">
            <!-- Benefits Section -->
            <div class="mb-8">
                <div class="space-y-3">
            ...
            <button wire:click="loginWithGoogle" wire:loading.attr="disabled"
                ...
                <svg wire:loading.remove
                    class="relative z-10 w-5 h-5 text-gray-400 group-hover:text-blue-600 group-hover:translate-x-1 transition-all duration-300"
            ...
            <div class="mt-6 text-center">
                <p class="text-xs text-gray-500 leading-relaxed">
                    ...
                    <a href="#" class="text-blue-600 hover:text-blue-700 font-medium hover:underline">Syarat &
                        Ketentuan</a>
                    dan
                    <a href="#" class="text-blue-600 hover:text-blue-700 font-medium hover:underline">Kebijakan
                        Privasi</a>
                </p>
            </div>
        </div>
        ...
        <div class="mt-8 text-center animate-fade-in">
            <div class="flex items-center justify-center gap-2 mb-3">
                <div class="flex -space-x-2">
                    <div class="w-8 h-8 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full border-2 border-white">
                    </div>
                    <div
                        class="w-8 h-8 bg-gradient-to-br from-green-400 to-green-600 rounded-full border-2 border-white">
                    </div>
                    <div
                        class="w-8 h-8 bg-gradient-to-br from-purple-400 to-purple-600 rounded-full border-2 border-white">
                    </div>
                </div>
            </div>
